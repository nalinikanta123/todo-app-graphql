...
export var useShowController = function (props) {
    ...
    var _c = useGetOne(resource, { id: id, meta: meta }, __assign({ enabled: (!isPendingAuthenticated && !isPendingCanAccess) ||
        ...
        }, retry: false }, otherQueryOptions)), record = _c.data, error = _c.error, isLoading = _c.isLoading, isFetching = _c.isFetching, isPaused = _c.isPaused, isPending = _c.isPending, isPlaceholderData = _c.isPlaceholderData, refetch = _c.refetch;
