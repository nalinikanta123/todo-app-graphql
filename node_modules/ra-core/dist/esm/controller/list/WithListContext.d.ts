 ...
 * );
 */
export declare const WithListContext: <RecordType extends RaRecord>({ render, }: WithListContextProps<RecordType>) => ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
