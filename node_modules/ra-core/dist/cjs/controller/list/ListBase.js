...
var ListBase = function (_a) {
    var children = _a.children, render = _a.render, loading = _a.loading, offline = _a.offline, props = __rest(_a, ["children", "render", "loading", "offline"]);
    ...
    var showLoading = isAuthPending &&
        !props.disableAuthentication &&
        loading !== undefined &&
        loading !== false;
    var isPaused = controllerProps.isPaused, isPending = controllerProps.isPending, isPlaceholderData = controllerProps.isPlaceholderData;
    ...
    React.createElement(core_1.OptionalResourceContextProvider, { value: props.resource },
        React.createElement(ListContextProvider_1.ListContextProvider, { value: controllerProps }, showLoading
            ? loading
            : showOffline
                ? offline
                : render
