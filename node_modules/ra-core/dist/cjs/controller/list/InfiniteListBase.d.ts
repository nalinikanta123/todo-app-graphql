...
import { InfiniteListControllerProps, InfiniteListControllerResult } from './useInfiniteListController';
 ...
 * );
 */
export declare const InfiniteListBase: <RecordType extends RaRecord = any>({ children, render, loading, offline, ...props }: InfiniteListBaseProps<RecordType>) => React.JSX.Element;
