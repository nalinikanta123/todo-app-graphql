 ...
 * );
 */
export declare const EditBase: <RecordType extends RaRecord = any, ErrorType = Error>({ children, loading, offline, render, ...props }: EditBaseProps<RecordType, ErrorType>) => React.JSX.Element;
