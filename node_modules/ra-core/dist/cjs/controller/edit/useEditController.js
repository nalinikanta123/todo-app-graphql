...
var useEditController = function (props) {
    ...
    var _g = (0, dataProvider_1.useGetOne)(resource, { id: id, meta: queryMeta }, __assign({ enabled: (!isPendingAuthenticated && !isPendingCanAccess) ||
        ...
        }, refetchOnReconnect: false, refetchOnWindowFocus: false, retry: false }, otherQueryOptions)), record = _g.data, error = _g.error, isLoading = _g.isLoading, isFetching = _g.isFetching, isPaused = _g.isPaused, isPending = _g.isPending, isPlaceholderData = _g.isPlaceholderData, refetch = _g.refetch;
    ...
    var _h = (0, dataProvider_1.useUpdate)(resource, recordCached, __assign(__assign({ onSuccess: function () {
            var args = [];
