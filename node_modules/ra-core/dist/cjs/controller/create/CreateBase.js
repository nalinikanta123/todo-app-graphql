...
var CreateBase = function (_a) {
    var children = _a.children, render = _a.render, _b = _a.loading, loading = _b === void 0 ? null : _b, props = __rest(_a, ["children", "render", "loading"]);
    ...
    React.createElement(core_1.OptionalResourceContextProvider, { value: props.resource },
        React.createElement(CreateContextProvider_1.CreateContextProvider, { value: controllerProps }, render ? render(controllerProps) : children)));
};
