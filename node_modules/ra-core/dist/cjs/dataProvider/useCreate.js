...
var useCreate = function (resource, params, options) {
    ...
    var mutation = (0, react_query_1.useMutation)(__assign(__assign({ mutationKey: [resource, 'create', params], mutationFn: function (_a) {
            ...
            if (mode.current === 'pessimistic') {
                var data_1 = args[0], variables = args[1];
                var _a = variables.resource, callTimeResource = _a === void 0 ? resource : _a;
                queryClient.setQueryData([callTimeResource, 'getOne', { id: String(data_1.id) }], data_1);
